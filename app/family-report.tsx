...
export default function FamilyReportScreen() {
  ...
  const filteredHistories = useMemo(() => Object.fromEntries(members.map((member) => {
  ...
  })), [histories, members, month, periodType]);
