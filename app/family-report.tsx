...
import { getStatusExpiry, isStatusMessageVisible, toggleSortDirection } from "@/lib/report-ui";
...
export default function FamilyReportScreen() {
  ...
  const shareReport = async () => {
    ...
    setStatusMessage("تم تجهيز التقرير للمشاركة."); setStatusExpiresAt(getStatusExpiry());
  };
  ...
  const downloadReport = async () => {
    ...
    setStatusMessage("تم تجهيز نسخة PDF للحفظ أو المشاركة."); setStatusExpiresAt(getStatusExpiry());
  };
