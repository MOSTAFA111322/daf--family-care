...
export default function FamilyReportScreen() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const savedSelection = await AsyncStorage.getItem(REPORT_SELECTION_KEY);
