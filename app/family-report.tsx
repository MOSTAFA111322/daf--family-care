...
import { appendReportOperation, clearReportOperations, createReportOperation, DEFAULT_REPORT_STATUS_DURATIONS, getReportStatusDuration, getStatusDurationLabel, getStatusExpiry, isReportStatusDuration, isStatusMessageVisible, type ReportAction, type ReportOperation, type ReportStatusDurations, toggleSortDirection } from "@/lib/report-ui";
...
export default function FamilyReportScreen() {
  ...
  const createPdf = async () => {
    setBusy(true);
    try {
      const html = buildFamilyReportHtml(sortedSelectedMembers, filteredHistories, periodLabel, reportLog);
